...
class _InformationsPersonnellesPageState extends State<InformationsPersonnellesPage> {
  final TextEditingController prenomController = TextEditingController(text: 'Lamine');
  final TextEditingController nomController = TextEditingController(text: 'Ndiaye');
  final TextEditingController specialiteController=TextEditingController(text:'Cardiologue');
